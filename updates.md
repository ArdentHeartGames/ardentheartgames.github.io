...
We're excited to launch the official Ardent Heart Games website! This site serves as the central hub for information about the Ardent Heart Editor and the Unicorn Game Engine.

**What's New:**
- Comprehensive documentation about the editor and engine
- Detailed features list
- Development roadmap with our vision for the future
- Regular updates section (you're reading it!)

We'll be posting regular updates here as development progresses. Stay tuned!
...
- **Example Projects** - Sample games and demos to learn from
- **Tutorial Series** - Step-by-step guides for common tasks
- **Developer Blog** - Technical deep-dives and development insights
...
This page will be updated regularly with the latest news and progress updates. Check back often to stay informed about the Ardent Heart Editor development!
...
[View Features](../features/) | [Check Roadmap](../roadmap/) | [About the Editor](../about/)
